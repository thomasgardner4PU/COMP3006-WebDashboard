...
import type { OperationDescription } from 'mongodb/src/cmap/message_stream';

import { PKG_VERSION, Snappy } from 'mongodb/src/deps';
import { MongoDecompressionError, MongoInvalidArgumentError } from 'mongodb/src/error';
