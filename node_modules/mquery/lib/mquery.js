...
const utils = require('mquery/lib/utils');
...
Query.permissions = require('mquery/lib/permissions');
...
Query.utils = utils;
Query.env = require('mquery/lib/env');
Query.Collection = require('mquery/lib/collection');
Query.BaseCollection = require('mquery/lib/collection/collection');
